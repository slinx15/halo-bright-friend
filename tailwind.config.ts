...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "premium": "0 4px 24px -4px hsl(var(--primary) / 0.15), 0 1px 3px hsl(var(--primary) / 0.08)",
        "premium-lg": "0 8px 40px -8px hsl(var(--primary) / 0.25), 0 2px 6px hsl(var(--primary) / 0.1)",
