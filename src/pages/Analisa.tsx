  ...
  return (
    <div className="p-4 md:p-6 space-y-4 max-w-[1400px] mx-auto w-full overflow-y-auto overflow-x-hidden pb-24 md:pb-6">
      ...
      <Tabs value={activeSection} onValueChange={(value) => setActiveSection(value as AnalysisSection)} className="w-full">
        <div className="rounded-2xl border border-border/80 bg-muted/45 p-1.5 shadow-sm shadow-black/5 dark:bg-card/85">
        ...
        <TabsContent value="restock" className="space-y-4 mt-4 animate-fade-in" style={{ animationFillMode: "both" }}>
          <Tabs value={restockView} onValueChange={(value) => setRestockView(value as RestockView)} className="w-full">
            <TabsList className="grid h-auto w-full grid-cols-3 rounded-2xl border border-border/75 bg-muted/50 p-1 shadow-sm dark:bg-card/85">
            ...
            <div className="sticky top-0 z-10 mt-3 space-y-3 rounded-2xl border border-border/75 bg-muted/40 px-3 py-3 shadow-sm ring-1 ring-black/5 backdrop-blur-sm dark:bg-card/88">
              <div className="flex gap-2">
                <div className="relative min-w-0 flex-1">
                  ...
                  <Input
                    ...
                    className="h-10 rounded-xl border-border/75 bg-background/98 pl-9 shadow-none dark:bg-background/85"
                  />
                </div>
                {restockView === "recommendations" && (
                  <Select value={restockSort} onValueChange={(value) => setRestockSort(value as RestockSort)}>
                    <SelectTrigger className="h-10 w-[118px] rounded-xl border-border/75 bg-background/98 text-xs shadow-none sm:w-[160px] dark:bg-background/85" aria-label="Urutkan daftar restock">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  return (
                    ...
                    className={`inline-flex min-h-9 items-center justify-center gap-1 rounded-xl border px-2 text-[11px] font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
                        isActive
                          ...
                          : "border-border/70 bg-background/96 text-muted-foreground hover:bg-background dark:bg-background/80"
                      }`}
                    >
                      {chip.label}
